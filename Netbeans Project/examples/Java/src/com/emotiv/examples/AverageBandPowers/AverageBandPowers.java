    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (ready) {
                ...
                DoubleByReference lbeta = new DoubleByReference(0);
                DoubleByReference hbeta = new DoubleByReference(0);
                DoubleByReference gamma = new DoubleByReference(0);
                DoubleByReference theta = new DoubleByReference(0);

                for (int i = 3; i < 17; i++) {
                    int result = Edk.INSTANCE.IEE_GetAverageBandPowers(userID.getValue(), i, theta, alpha, lbeta, hbeta, gamma);
                    if (result == EdkErrorCode.EDK_OK.ToInt()) {
                        System.out.print(theta.getValue());
                        System.out.print(", ");
                        System.out.print(alpha.getValue());
                        System.out.print(", ");
                        System.out.print(lbeta.getValue());
                        System.out.print(", ");
                        System.out.print(hbeta.getValue());
                        System.out.print(", ");
